...
- `202607090005_add_push_subscriptions.sql`: Web Push subscription storage for PWA notifications.
- `202607100001_add_agent_daily_usage.sql`: daily Agent usage counter for expensive model limits.
